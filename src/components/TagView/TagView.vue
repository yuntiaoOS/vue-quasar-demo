...
export default {
  ...
  data () {
    return {
      tagView: this.$store.state.skin.tagView
    }
  },
  computed: {

    getTagView () {
      return this.$store.state.skin.tagView
    },
  ...
  watch: {
    getTagView (n, o) {
      console.log('-------------getTagView---------------------',n, o)
      this.tagView = n
      this.$store.commit('skin/SET_KEEPALIVE_LIST', this.tagView)
  ...
  methods: {
    ...
    removeAllTagView () {
      this.$store.commit('skin/REMOVE_TAG_VIEW')
    },

    removeAtagView (i) {
      this.$store.commit('skin/REMOVE_TAG_VIEW', i)
    },

    removeLeftTagView (i) {
      this.$store.commit('skin/REMOVE_TAG_VIEW', { side: 'left', index: i })
    },

    removeRightTagView (i) {
      this.$store.commit('skin/REMOVE_TAG_VIEW', { side: 'right', index: i })
    },

    removeOthersTagView (i) {
      this.$store.commit('skin/REMOVE_TAG_VIEW', { side: 'others', index: i })
    }
